...
class FakeFlowTechnoRepository {
...
describe('FlowTechnoService', () => {
  let service: FlowTechnoService;
  let fakeSearchIndex: FakeSearchIndex;
  let fakeRepo: FakeFlowTechnoRepository;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        FlowTechnoService,
        {
          provide: getRepositoryToken(FlowTechnoRepository),
          useClass: FakeFlowTechnoRepository,
        },
        {
    ...
    service = module.get<FlowTechnoService>(FlowTechnoService);
    fakeSearchIndex = module.get(SEARCH_CLIENT_PROVIDER)
      .current as FakeSearchIndex;
    fakeRepo = module.get(
      getRepositoryToken(FlowTechnoRepository),
    ) as FakeFlowTechnoRepository;
  });
